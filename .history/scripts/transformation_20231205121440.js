...
console.log("y3:", y3);
      ...
      function saveImageWithBackgroundColor(color) {
        // Створити тимчасове полотно
        var tempCanvas = document.createElement('canvas');
        tempCanvas.width = canvas.width;
        tempCanvas.height = canvas.height;
        var tempContext = tempCanvas.getContext('2d');
    
        // Заповнити тимчасове полотно фоновим кольором
        tempContext.fillStyle = color;
        tempContext.fillRect(0, 0, tempCanvas.width, tempCanvas.height);
    
        // Намалювати елементи на тимчасовому полотні (можна використовувати вашу функцію drawIsoscelesTriangle)
        drawIsoscelesTriangle(50, 50, 150, 50, 100, 150, [120, 50, 70]);
    
        // Встановити режим "source-in" для прозорості
        tempContext.globalCompositeOperation = 'source-in';
    
        // Скопіювати елементи з оригінального полотна на тимчасове
        tempContext.drawImage(canvas, 0, 0);
    
        // Скинути режим compositing
    ...
    // Викликати функцію для збереження зображення з білим фоном
    saveImageWithBackgroundColor('white');
