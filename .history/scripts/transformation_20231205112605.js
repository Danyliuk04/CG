var originalTriangle;
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      moveAndReflectTriangle = function () {
        ...
        var x1 = parseFloat(document.getElementById('x1').value) + 200;
var y1 = parseFloat(document.getElementById('y1').value);
var x2 = parseFloat(document.getElementById('x2').value) + 200;
var y2 = parseFloat(document.getElementById('y2').value);
var x3 = parseFloat(document.getElementById('x3').value) + 200;
...
console.log("y3:", y3);
        ...
        var scale = 0.5;
        var X1 = 2 * 200 - scale * originalTriangle.x1 - 250;
        var Y1 = 2 * 200 - scale * originalTriangle.y1 - 150;
        var X2 = 2 * 200 - scale * originalTriangle.x2 - 250;
        var Y2 = 2 * 200 - scale * originalTriangle.y2 - 150;
        var X3 = 2 * 200 - scale * originalTriangle.x3 - 250;
        var Y3 = 2 * 200 - scale * originalTriangle.y3 - 150;
