var originalTriangle;
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function drawIsoscelesTriangle(x1, y1, x2, y2, x3, y3, hslString) {
        var hslString = `hsl(${hslValues[0]}, ${hslValues[1]}%, ${hslValues[2]}%)`;
...
console.log("y3:", y3);
        ...
        drawIsoscelesTriangle(x1, y1, x2, y2, x3, y3, [120, 80, 25]);
