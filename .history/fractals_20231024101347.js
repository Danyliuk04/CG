...
const canvas = document.getElementById("fractalCanvas");
        ...
        document.getElementById("standardConfigButton").addEventListener("click", function () {
            ...
            if (selectedFractalType === "algebraic") {
                maxIterations = document.getElementById("iterations").value = 100;
                zoom = document.getElementById("scale").value = 80;
                
                drawAlgebraicFractal();
            } else if (selectedFractalType === "glacial") {
                maxIterations = document.getElementById("iterations").value = 4;
                zoom = document.getElementById("scale").value = 100;
                drawGlacialFractal();
            }
